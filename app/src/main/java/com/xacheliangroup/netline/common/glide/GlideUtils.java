package com.xacheliangroup.netline.common.glide;
...
import com.xacheliangroup.netline.GlideApp;
...
public class GlideUtils {
    ...
    public static void toLoadBitmap(Context context,byte[] bytes,ImageView imageView){
        GlideApp.with(context).load(bytes).into(imageView);

    }
    public static void toLoadBitmap(Context context, Bitmap bitmap, ImageView imageView){
//        GlideApp.with(context).asBitmap().load(bitmap).into(imageView);
