...
import com.xacheliangroup.netline.common.base.pullrefresh.core.OnPullListener;
import com.xacheliangroup.netline.common.http.okhttp.IActionListener;
import com.xacheliangroup.netline.moduleCarCircle.mvp.CirclePresenter;
import com.xacheliangroup.netline.moduleCarCircle.mvp.bean.CarCircleItemBean;
...
/**
 * author:yz
 * data: 2018/12/24,10:21
 */
public class RecommendCircleFragment extends BaseFragment implements IActionListener.ViewAction{
    private static final String mAllType="3";
    private int mPageSize=1;
    CirclePresenter mCirclePresenter;
    @BindView(R.id.module_Cbb_car_circle_recommend_rl)
    RefreshLayout mRefreshLayout;
    @BindView(R.id.module_Cbb_car_circle_recommend_rv)
    ...
    protected int getLayoutId() {
        return R.layout.module_cbb_fragment_circle_recommend;
    }
