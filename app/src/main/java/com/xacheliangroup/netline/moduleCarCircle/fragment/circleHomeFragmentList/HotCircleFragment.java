 ...
 */
public class HotCircleFragment extends BaseFragment implements IActionListener.ViewAction{
    private static final String mAllType="2";
    private int mPageSize=1;
    CirclePresenter mCirclePresenter;
    @BindView(R.id.module_Cbb_car_circle_hot_rl)
    RefreshLayout mRefreshLayout;
    @BindView(R.id.module_Cbb_car_circle_hot_rv)
    ...
    protected int getLayoutId() {
        return R.layout.module_cbb_fragment_circle_hot;
    }
