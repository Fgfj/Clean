...
import com.xacheliangroup.netline.checkTickets.activity.CTCheckActivity;
...
public class CTCheckFragment extends BaseFragment implements IActionListener.ViewAction {
    ...
    private static final String SN = "123";
            ...
            case CTPresenter.TO_GET_CAR_DETAIL_DATA://获取班次信息
                if (obj != null && obj instanceof List) {
                    ...
                    if (list.size() != 0) {
                        ...
                        mSellNumberTx.setText(mCtCarDetailBean.getSaleNum() + "");
